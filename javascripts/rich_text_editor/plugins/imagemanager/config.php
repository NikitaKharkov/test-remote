<?php
	...
	$mcImageManagerConfig['filesystem.rootpath'] = realpath($_SERVER['DOCUMENT_ROOT'] . '/uploads/CustSupport/Images'); // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['filemanager.urlprefix'] = "../filemanager"; // need to add "filemanager" button to toolbar as well.
?>