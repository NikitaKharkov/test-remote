...
?>
	...
	<h1>Knowledge Base: Search by Database</h1>
	<br />
	...
	<div class="center_table">
		<form id="search" action="<?= $_SERVER['PHP_SELF']; ?>" method="get">
			<table cellpadding="13" cellspacing="0" class="form_table_search_db">
				<tr>
					<th colspan="2" class="browse_header">Knowledge Base: Search by Database</th>
				</tr>
				<tr>
