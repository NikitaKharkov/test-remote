...
--------------------------------------------------------- */
	...
	$rating_dbhost        = 'supportdb102epnet.com';
	$rating_dbuser        = 'faqUser';
	$rating_dbpass        = 'c0mm3ntsOnu5';
	$rating_dbname        = 'faq_ratings';
	$rating_tableName     = 'ratings';
	$rating_path_db       = '/knowledge_base/'; // the path to your db.php file (not used yet!)
	$rating_path_rpc      = '/knowledge_base/'; // the path to your rpc.php file (not used yet!)
