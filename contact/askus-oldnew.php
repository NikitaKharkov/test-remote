...
<div id="page_title">EBSCO Support</div>
<?
...
if ($page_function == "send") {
    ...
    $to = "dpersakis@ebsco.com"; //	Live e-mail account
    ...
    $m .="Service: " . stripslashes($services[ $_REQUEST['service'] ]) . "\n";
    ...
    $m .="Category: " . stripslashes($categories[ $_REQUEST['category'] ]) . "\n";
    $m .="Email: " . stripslashes($_REQUEST['email']) . "\n";
		$m .="Product: ". stripslashes($products[ $_REQUEST['product'] ])."\n\n"; 
...
<br /><br />
<span class="red"><b>Patrons/Students/End Users</b></span>: <b>The librarian or administrator at your institution can best handle your inquiry. For your convenience, frequently asked questions (FAQs), training, and tutorial links are available on the right side of this page.</b></div>
