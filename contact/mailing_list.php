<?php
header("Location: http://www.ebscohost.com/support/mailing-list");
?>
<?
/* --------------------------------------------------------------------- */
...
if ($page_function == "show_form") {
	...
	if(!$message && !$error){
		...
		<div id="detail"><h3>Sign up to join any (or all) of our mailing lists. It's free!</h3>
...
<br />
<table cellpadding="6" cellspacing="1" border="0" class="option_table">
	...
	<tr>
		<td colspan="2">* E-mail <span class="small">(confirm)</span>:<br /><input style="width:200px;" type="text" name="emailcf" value="<?= stripslashes($emailcf); ?>" maxlength="50" tabindex="10" /></td>
	</tr>
	<tr>
	...
	<tr>
		<td align="center" colspan="2"><input type="hidden" name="page_function" value="send" /> <input type="submit" alt="Submit" value="Submit" class="greenbtn" tabindex="16" onclick="return BothFieldsIdenticalCaseSensitive();" /></td>
	</tr>
</table>
