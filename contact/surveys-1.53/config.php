...
$databasepass       =   "surv3y@pp";            // Password of db user
...
// FILE LOCATIONS
$rooturl            =   "http://{$_SERVER['SERVER_NAME']}/contact/surveys"; //The root web url for your limesurvey installation.
...
$defaultpass        =   "lam3surv3ys";       // This is the default password for the default user when LimeSurvey is installed
...
$shownoanswer       =   0;                // Show "no answer" for non mandatory questions
...
$siteadminname      =   "Customer Success";      // The name of the site administrator
