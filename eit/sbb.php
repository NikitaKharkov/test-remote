...
$useThisDomain = 'https://' . $_SERVER['HTTP_HOST'];
...
?>
		...
		<p>Choose your search parameters and customize your search box<br />size and style to fit your site.</p>
				<div class="leftblock">
					...
					<ul class="general">
						<li>
							<a target="_blank" href="https://connect.ebsco.com/s/article/Create-an-EBSCO-search-box">How do I embed an EBSCOhost search box on to my website?</a>
						</li>
						<li>
							<a target="_blank" href="https://connect.ebsco.com/s/article/How-do-I-use-the-EBSCO-Search-Box-Builder-tool">How do I use the EBSCO Search Box Builder tool?</a>
						</li>
		...
		<form id="sbbForm" name="form1" onsubmit="return false;">
			<div id="sbbMainContainer">
				...
				<!-- Publication Type ( EHOST & EDS )
					HIDING THIS SECTION--
					Pubtype searching is now specific to databases--
					we can't just pass PT82 such as we were when this was first built.
				-->
				...
				<div id="customizeLayout">
					...
					<ul>
						...
						<li>
							<div data-class="showChooseDatabasesContainer" class="showChooseDatabasesContainer">
...
var thisdomain = '<?php echo $useThisDomain; ?>';
</script>
<script type="text/javascript" src="js/jsrender.js?t=<?php echo time(); ?>"></script>
<script type="text/javascript" src="js/knockout.js?t=<?php echo time(); ?>"></script>
<script type="text/javascript" src="js/sbb-interfaces.js?t=<?php echo time(); ?>"></script>
<script type="text/javascript" src="js/sbb-dbfilter.js?t=<?php echo time(); ?>"></script>
<script type="text/javascript">

//console.log("last change","2019-09-03 12:01");

	function showCustID() {
		var currentcustid = $("#customerId").val();
		console.log("custid lenght" + currentcustid.length);
		var auths = [];
	...
	function formReset() {
		...
		if (resetPrompt == true) {
      amplitude.getInstance().logEvent('Form - reset',{});
...
include( 'includes/footer_sbb.php' );
