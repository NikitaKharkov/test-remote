...
<div style="float: left; margin-top: 22px; font-size: 16px; margin-left: 15px;">
	(<a href="ws_api_search.php">Standard</a>, <strong>EDS</strong>, <a href="ws_api_search_ehis.php">EHIS</a>)
</div>
...
<ul>
	<li><a href="#a">Searching with Discovery Services</a></li>
...
<p class="highlight3">
	Note: 
	This is the Discovery Service version of the Search method, and will only work with
	a Discovery Service enabled profile.  <a href="ws_search.php">Click here</a> for the
	standard Search method.
</p>

<div class="hr" ></div>

<a name="a"></a><h3 style="float: left;">Searching with EDS</h3>
...
<p>
	Searching with an EDS profile is very similar to searching with a normal EIT profile.  The
	differences are as follows:
	<ul>
		<li>
			The <code>db</code> field is not required, as profiles with EDS enabled will search all databases
			in their profile.
		</li>
		<li>
			The only two sort options available are <code>date</code> and <code>relevance</code>.  In normal EIT
			profiles, sort options are available through the Info method.
		</li>
		<li>
			Only the Search method is available to EDS web service profiles.  The Info, Browse and AuthoritySearch methods are not supported at this time.
		</li>
		<li>Since no Info method is available, and search tags vary by database, here is the recomended list of search
		tags to use when formatting queries:
		<br><br>
...
<p>
	...
	formats for full text, etc. In the Fulltext format the rec element can also contain the <code>&lt;abody&gt;</code> element
