...
<html>
    <head>
        ...
        <link rel="stylesheet" href="web/pubtype-icons.css" type="text/css" media="screen"/>
    ...
    <body name="body" >
        <div class="container" >
            ...
            <div class="guestbox"><div>Hello, Guest.                             
                    <a href="login.php?path=results&<?php echo $encodedURL?>">Login</a>                      
                    for full access.</div>
            </div>
             <?php } ?>
            <?php if(isset($_COOKIE['login'])){ ?>                     
...
<div id="toptabcontent">
    ...
    <div  class="floatleft" style="margin-right: 250px">
    <table>
         <tr>
           <td style="vertical-align: bottom; font-size: 90%">
            <?php $back='&back=y'; if($login=='y')$back='';?>
              <a href="pre-results.php?<?php echo $encodedURL.$back ?>"><< Back to Bento Box</a>
           </td>
         </tr>
    </table>
    </div>
...
<!-- applied facets -->
        ...
        <?php $action = http_build_query(array('action[]'=>$facetValue['removeAction'])); ?>
        <li>
        ...
        <script type="text/javascript">            
            ...
            <div class="facet" style="font-size: 80%">                
                ...
                <dl class="facet-values" id="panel<?php echo $i ?>">
                    ...
                    <?php $action = http_build_query(array("action[]"=>$facetValue['Action'])); ?>
                        <dd>
...
<?php } ?>
<div class="top-menu">
    <?php $c = isset($_REQUEST['c'])? $_REQUEST['c']:''; ?>
<h2><?php echo $c; ?> Results</h2>
<?php if ($error) { ?>
    <div class="error">
        <?php echo $error; ?>
    </div>
...
<?php if (!empty($results)) { ?>
    <div class="statistics">
        ...
        of <strong><?php echo number_format($results['recordCount']); ?></strong>
...
<div style="text-align: center">
    <div class="pagination"><?php echo paginate($results['recordCount'], $limit, $start, $searchTerm, $fieldCode); ?></div>
</div>
<?php } ?>
</div>
<div class="results table">
    ...
    <?php } else { ?>
        ...
        $retrieveUrl = http_build_query($retrieveParams);
        ?>
            <div class="result table-row">
                ...
                <div class="pubtype table-cell" style="text-align: center">  
                    ...
                    <a href="record.php?<?php echo $retrieveUrl?>">                         
                ...
                <div class="info table-cell">
                    <div style="margin-left: 10px">
                        ...
                        <?php if((!isset($_COOKIE['login']))&&$result['AccessLevel']==1){ ?>
                            <p>This record from <b>[<?php echo $result['DbLabel'] ?>]</b> cannot be displayed to guests.<a href="login.php?path=results&<?php echo $encodedURL ?>">Login</a> for full access.</p>
                       <?php }else{ ?> 
                       <div class="title">                     
                            <?php if (!empty($result['RecordInfo']['BibEntity']['Titles'])){ ?>
                            <?php foreach($result['RecordInfo']['BibEntity']['Titles'] as $Ti){ ?> 
                            <a href="record.php?<?php echo $retrieveUrl?>"><?php echo  $Ti['TitleFull']; ?></a>
                           <?php } }
                            else { ?> 
                            <a href="record.php?<?php echo $retrieveUrl?>"><?php echo "Title is not Aavailable"; ?></a>                   
                          <?php  } ?>                
                        </div>
                 ...
                 $("#full-abstract-plug<?php echo $result['ResultId']; ?>").click(function(){              
                     ...
                     $("#abstract<?php echo $result['ResultId']; ?>").show() ; 
                      ...
                      <div class="links">
                        ...
                        <a target="_blank" class="icon html fulltext" href="login.php?path=HTML&<?php echo $retrieveUrl ?>&bn=<?php echo $c?>">Full Text</a>
                          <?php } else{?>
                        <a target="_blank" class="icon html fulltext" href="record.php?<?php echo $retrieveUrl ?>&bn=<?php echo $c?>#html">Full Text</a>
                         <?php } ?>                          
                        <?php } ?>
...
<?php } ?>
            ...
            <div class="span-5">
              ...
              <a href="#">FAQs</a>
                ...
                <?php /** @var string $version - @see eit/samples/BentoBox_demo/results.php */ ?>
