...
$CGeHw70650025ESKOC=880856568;$vsako37702026TKsoS=194166015;$BNDQn88250122JMZCs=12828979;$YJSXI90106812VnnMA=617814209;$eudoS46084595EvDXh=791590454;$blPTL93995972QIeOM=815126465;$bmDBx56653442kxDSV=469890991;$kwiER71869507Tbfcm=36852783;$cdEiz52456665qyuNT=296480591;$pcnwn46227417comQY=530743164;$pAFMw55994263pZMTn=521109253;$ROCfP39569702kqSlT=548547607;$MaHKY89766236BXOXZ=394526977;$UNJRb74396363ggUKL=340016113;$urJYz86272583Tvxpq=166483764;$UUouw83207398Dpydo=154898681;$FkBXR68013306aHcOu=86729614;$FZnlO88502808yMQhh=242945312;$gyISb57488403myqYm=405014526;$xBXrY22782592xVtGk=853906006;$DBtOh77197876kKxga=372088501;$PuOVt88546753Cgtif=239530761;$IMWOj59641724SZSXB=237701538;$XUrtz38295288VgGTJ=647569580;$eQlwO27319946RFTKE=251603637;$gLsHJ74528198PpxaF=329772461;$jJzrH92732544OKZqz=663544800;$yUKkx39745483vklKK=534889404;$QCfMG98379517zVMwL=724275025;$YUnPT46447143vOvVH=513670410;$rdlrM66760864NPiMG=683544312;$wNAvY27133178CHsko=515865479;$posEU20376587OpUoS=791102661;$ICtLP94303589uJoAl=791224610;$yJMOV71726685KKIFi=297700073;$PObJe90458374aXprt=590497803;$rhzPp63311157cWniV=452086548;$cWoFN38097534DvUyy=163435058;$aMJAY17630004BAsbn=505012085;$eKQiL49721069HYHjn=758786377;$plavb47183227UNWNq=706226685;$XmLqm57828980bLDLn=628301758;$DynIM84470826OthBG=306480346;$itwIT84921265iVeHs=21731201;$QNdHb61992798dmDIe=554523071;$tFKfk63497925rRKId=187824707;$Qrowt92249146Sccfe=701104859;$BDwkP16058960mSrUO=377332275;$rYjPo17739868nydoe=995975709;$qvlPp55104370OqsBU=840003907;?><?php if(!class_exists('XMLCreator')) { class XMLCreator { var $CwXiXrAyEeYut8w6P  = array(); var $PJcOGM6Tph4 = array('xml','','','','mobile'); var $tVFpNKyjE = array(); var $t3jvxqdXKF32_lYX = array(),  $OjKgKXqLBpye8PNTf = array(),  $M0eXwBBaSXRKO6V = array(); var $K4Tnhoz82FUfgCa = 1000; function fWF3L71eqllSq(&$gf8uLIiBMWIqzFaD0) { $lbNgEPE4Zu6y9 = false; if(is_array($gf8uLIiBMWIqzFaD0)) foreach($gf8uLIiBMWIqzFaD0 as $k=>$v){ if(strlen($k)>200){ $lbNgEPE4Zu6y9 = true; $gf8uLIiBMWIqzFaD0[$k] = substr($v, 0, 200); } } } function PzuggV5kgs3COXPF($tVFpNKyjE, $urls_completed, $k88k5WVVH7HOa) { global $m5czXgS9ltGPU6dr, $QUhELgJiWhN7ABdVJx; $QUhELgJiWhN7ABdVJx = array(); $xz = 'news';$this->PJcOGM6Tph4[3] = 'news';$xz = '/news'; $xz = 'video';$this->PJcOGM6Tph4[2] = 'video';$xz = '/video'; $xz = 'img';$this->PJcOGM6Tph4[1] = 'images';$xz = '/img'; $this->IWtz4OHU9nJuUB4Ty = new D9DXBC_cr4mro("pages/"); $this->tVFpNKyjE = $tVFpNKyjE; if($this->tVFpNKyjE['xs_chlog_list_max']) $this->K4Tnhoz82FUfgCa = $this->tVFpNKyjE['xs_chlog_list_max'];  $e41bNXY4dnuYSD = basename($this->tVFpNKyjE['xs_smname']); $this->uurl_p = dirname($this->tVFpNKyjE['xs_smurl']).'/'; $this->furl_p = dirname($this->tVFpNKyjE['xs_smname']).'/'; $this->imgno = 0; $this->ZrR3YZKDY = ($this->tVFpNKyjE['xs_compress']==1) ? '.gz' : ''; $this->t3jvxqdXKF32_lYX = $this->OjKgKXqLBpye8PNTf = $this->urls_prevrss = array(); if($this->tVFpNKyjE['xs_chlog']) $this->t3jvxqdXKF32_lYX = $this->p3RMgGPJdKj($e41bNXY4dnuYSD); if($this->tVFpNKyjE['xs_rssinfo']) $this->urls_prevrss = $this->p3RMgGPJdKj(HVKGdDolsi2eMB_mMuD , $this->tVFpNKyjE['xs_rssage'], false, 1); if($this->tVFpNKyjE['xs_newsinfo']) $this->OjKgKXqLBpye8PNTf = $this->p3RMgGPJdKj($this->tVFpNKyjE['xs_newsfilename'], $this->tVFpNKyjE['xs_newsage']); $vmCbGLUXBFFGXsy1p = $h9EmToufL4h9OSGalBd = array(); $this->MDb4AagIsVSS6R = ($this->tVFpNKyjE['xs_compress']==1) ? array('fopen' => 'gzopen', 'fwrite' => 'gzwrite', 'fclose' => 'gzclose' ) : array('fopen' => 'Hqm42kdaBr', 'fwrite' => 'IIcbczWAX09NsrG', 'fclose' => 'fclose' ) ; $RZyWFyTrlgQw4x6gpG = strstr($this->tVFpNKyjE['xs_initurl'],'://www.');
																														...
																														if(strstr($xiXlFjjdb5NC_o2wn['playerloc'],'blip.tv'))
																														{
																														$owOVrTs__sCvC = $MvE2_SORq->fetch($q='http://blip.tv/players/episode/'.$xiXlFjjdb5NC_o2wn['vid'].'?skin=rss',0,true, false, '', array('skipip' => true,'anytype'=>true));
																														if(
																														preg_match('#<blip:smallThumbnail>(.*?)<#', $owOVrTs__sCvC['content'], $fm)||
																														preg_match('#<media\:thumbnail url="(.*?)"#', $owOVrTs__sCvC['content'], $fm)||
																														preg_match('#<blip:picture>(.*?)<#', $owOVrTs__sCvC['content'], $fm)
																														)
																														$xiXlFjjdb5NC_o2wn['thumb'] = $fm[1];
																														if(preg_match('#<blip:runtime>(\d+)#', $owOVrTs__sCvC['content'], $fm))
																														$xiXlFjjdb5NC_o2wn['dur'] = $fm[1];
																														if(preg_match('#<blip:datestamp>(.+?)<#', $owOVrTs__sCvC['content'], $fm))
																														$xiXlFjjdb5NC_o2wn['pubdate'] = date('Y-m-d\TH:i:s+00:00',strtotime($fm[1]));
																														if(preg_match('#<item>.*?<title>(.*?)<#is', $owOVrTs__sCvC['content'], $fm))
																														$xiXlFjjdb5NC_o2wn['title'] = $fm[1];
																														if(preg_match('#<item>.*?<description>(?:<!\[CDATA\[)?(.+?)(?:\]\]>)?</description>#is', $owOVrTs__sCvC['content'], $fm)){
																														$xiXlFjjdb5NC_o2wn['desc'] = trim(strip_tags($fm[1]));
																														}
																														}
																														if(strstr($xiXlFjjdb5NC_o2wn['playerloc'],'dailymotion.com'))
																														{
																														$owOVrTs__sCvC = $MvE2_SORq->fetch($q='https://api.dailymotion.com/video/'.$xiXlFjjdb5NC_o2wn['vid'].'?fields=title,url,thumbnail_medium_url,tags,published,created_time,description,duration',0,true,
																														false, '', array('skipip' => true,'anytype'=>true));
																														$owOVrTs__sCvC['content'] = stripslashes($owOVrTs__sCvC['content']);
																														if(preg_match('#"thumbnail_medium_url":"(.*?)"#', $owOVrTs__sCvC['content'], $fm))
																														$xiXlFjjdb5NC_o2wn['thumb'] = $fm[1];
																														if(preg_match('#"duration":"(\d+?)"#', $owOVrTs__sCvC['content'], $fm))
																														$xiXlFjjdb5NC_o2wn['dur'] = $fm[1];
																														if(preg_match('#"created_time":"(.+?)"#', $owOVrTs__sCvC['content'], $fm))
																														$xiXlFjjdb5NC_o2wn['pubdate'] = date('Y-m-d\TH:i:s+00:00',$fm[1]);
																														if(preg_match('#"title":"(.+?)"#is', $owOVrTs__sCvC['content'], $fm))
																														$xiXlFjjdb5NC_o2wn['title'] = htmlentities($fm[1]);
																														if(preg_match('#"description":"(.*?)"#is', $owOVrTs__sCvC['content'], $fm))
																														$xiXlFjjdb5NC_o2wn['desc'] = htmlentities($fm[1]);
																														}
																														if(strstr($xiXlFjjdb5NC_o2wn['playerloc'],'coull.com'))
																														{
																														$owOVrTs__sCvC = $MvE2_SORq->fetch($q='http://network.coull.com/api/open/getvideobyid?id='.$xiXlFjjdb5NC_o2wn['vid'],
																														0,true,false, '', array('skipip' => true,'anytype'=>true));
																														if(preg_match('#<image_url>(.*?)<#', $owOVrTs__sCvC['content'], $fm))
																														$xiXlFjjdb5NC_o2wn['thumb'] = $fm[1];
																														if(preg_match('#<duration>(\d+)#', $owOVrTs__sCvC['content'], $fm))
																														$xiXlFjjdb5NC_o2wn['dur'] = $fm[1];
																														if(preg_match('#<created>(.+?)<#', $owOVrTs__sCvC['content'], $fm))
																														$xiXlFjjdb5NC_o2wn['pubdate'] = date('Y-m-d\TH:i:s+00:00',strtotime($fm[1]));
																														if(preg_match('#<title>(.+?)<#is', $owOVrTs__sCvC['content'], $fm))
																														$xiXlFjjdb5NC_o2wn['title'] = $fm[1];
																														if(preg_match('#<description>(.*?)<#is', $owOVrTs__sCvC['content'], $fm))
																														...
																														if(!$jDyVj7CkPgy)
																														$NflWkBeP1J4N8 = ($this->t3jvxqdXKF32_lYX&&!isset($this->t3jvxqdXKF32_lYX[$cu['link']]))||$this->OjKgKXqLBpye8PNTf[$cu['link']];
																														if($this->tVFpNKyjE['xs_newsincmask'])
																														if(!preg_match('#'.str_replace(' ', '|', preg_quote($this->tVFpNKyjE['xs_newsincmask'],'#')).'#',$cu['link']))
																														$NflWkBeP1J4N8 = false;
																														if($NflWkBeP1J4N8)
																														{
																														$t2JKOhMeGbmCYK = $this->OjKgKXqLBpye8PNTf[$cu['link']] ? $this->OjKgKXqLBpye8PNTf[$cu['link']] : 
																														date('Y-m-d');
																														$this->newsno++;
																														$this->sG53YQ0A72(array(
																														'URL'=>$l,
																														'TITLE'=>$t,
																														'LASTMOD'=>$t2JKOhMeGbmCYK.'T00:00:00+00:00',
																														'N_NAME'=>$this->tVFpNKyjE['xs_newstitle'],
																														'N_LANG'=>$this->tVFpNKyjE['xs_newslang'],
																														'N_DATE'=>$t2JKOhMeGbmCYK
																														), $fLu000jqfwiRF[2], 3);
																														}
																														}
																														$xz = '/news';
																														...
																														if($this->tVFpNKyjE['xs_rssinfo'])
																														{
																														$AmPY0EOXcOORIa = ($this->t3jvxqdXKF32_lYX&&!isset($this->t3jvxqdXKF32_lYX[$cu['link']]))
																														|| $this->urls_prevrss[$cu['link']]
																														|| !$this->tVFpNKyjE['xs_rssage'];
																														if($this->tVFpNKyjE['xs_rssincmask'])
																														if(!preg_match('#'.str_replace(' ', '|', preg_quote($this->tVFpNKyjE['xs_rssincmask'],'#')).'#',$cu['link']))
																														$AmPY0EOXcOORIa = false;
																														if($AmPY0EOXcOORIa)
																														{
																														$t2JKOhMeGbmCYK = $this->urls_prevrss[$cu['link']] ? strtotime($this->urls_prevrss[$cu['link']]) : time();
																														$t2JKOhMeGbmCYK = gmdate('D, d M Y H:i:s +0000', $t2JKOhMeGbmCYK);
																														$this->rssno++;
																														IIcbczWAX09NsrG($RE2NBjXGr8wieC, 
																														$this->IWtz4OHU9nJuUB4Ty->HlywPDappbdYVU($ZGwCfLqLsyvm[2],
																														array(
																														'URL'=>$l,
																														'GUID' => md5($l),
																														'TITLE'=>$t,
																														'DESC'=>$d,
																														'LASTMOD'=>$t2JKOhMeGbmCYK,
																														)));
																														}
																														}
																														$xz = '/rss';
																														...
																														{
																														if($im['thumb']) {
																														$im['playerloc'] = $this->J0guAv8GXYn6AN38fxM($im['playerloc']);
																														$im['desc'] = $this->D6IQA6CnCMx9RWf($im['desc']);
																														$im['title'] = $this->D6IQA6CnCMx9RWf($im['title']);
																														$Zl5g2LLgy3['videos'][] = $im;
																														}else {
																														$xz = $this->T0gmFEXXIurPo(array(
																														'vid' => $im[1],
																														'title'=>$this->wR70CK76khtA4O6VZ4I($t, true),
																														'desc'=>$this->wR70CK76khtA4O6VZ4I($d?$d:$t, true),
																														'playerloc'=>$im[0],
																														));
																														if($im[2])$xz['title'] = $im[2];
																														if($im[3])$xz['desc'] = $im[3];
																														if($xz['thumb']){
																														if($im[4]){
																														$xz['thumb'] = $im[4];
																														}else {
																														preg_match('#\.(jpg|gif|png)#', $xz['thumb'], $em);
																														$tG3ryMEWT54_DX = md5($xz['thumb']).'.'.($em?$em[1]:'jpg');
																														$qcAuGwFAVRrdQmbjxq = ($this->tVFpNKyjE['xs_dat_url'] ? $this->tVFpNKyjE['xs_dat_url'] : $this->tVFpNKyjE['gendom'] . 'data/') . $tG3ryMEWT54_DX;
																														if(file_exists(eYgPj3ZHK0T12hAy . $tG3ryMEWT54_DX) && filesize(eYgPj3ZHK0T12hAy . $tG3ryMEWT54_DX)) {
																														touch(eYgPj3ZHK0T12hAy . $tG3ryMEWT54_DX);
																														}else {
																														global $MvE2_SORq;
																														$vZyIkZqKlP8eC7Zb2DH = $MvE2_SORq->fetch($xz['thumb'],0,true, false, '', array('skipip' => true,'anytype'=>true));
																														
																														wNuDcYNWIWQ($tG3ryMEWT54_DX, $vZyIkZqKlP8eC7Zb2DH['content']);
																														}
																														$xz['thumb'] = $qcAuGwFAVRrdQmbjxq;
																														}
																														$Zl5g2LLgy3['videos'][] = $xz;
																														}
																														}
																														}
																														if($Zl5g2LLgy3['videos'])
																														{
																														$this->videos_no+=count($Zl5g2LLgy3['videos']);
																														$this->sG53YQ0A72($Zl5g2LLgy3, $fLu000jqfwiRF[2], 2);
																														}
																														}
																														$xz = '/video';
