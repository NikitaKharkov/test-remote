...
define('DATABASE_USER', 'mysql');
define('DATABASE_PASS', 'n6Tt54');

define('DATE_FORMAT', 'M j, Y');
define('DATETIME_FORMAT', 'M j, Y g:ia');

define('_PERSONAL_SEARCH_DICTIONARY', '/var/www/html/support.epnet.com/knowledge_base/search_custom.pws'); // use the personal dictionary
...
$objects->configureClass('Database', 'localhost', DATABASE_NAME, DATABASE_USER, DATABASE_PASS, 'mysql');
